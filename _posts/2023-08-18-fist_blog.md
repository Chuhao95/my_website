...
Use Youtube API to extract thumbnail data from my wife's [Youtube Channel](https://www.youtube.com/channel/UCN_hbfsIsYgj-PtGJT8aSAQ). You need to replace `Your Youtube API` with your own API key which can be obtained from Youtube Data API key from [here](https://developers.google.com/youtube/v3).
...
Now app is live and running in Hugging Face Space! You can try my app on HF space [here](https://huggingface.co/spaces/Old-Fat-Boy/Youtube_Thumbnail_CTR_Analyzer)
...
Thanks for reading! Happy coding! Thanks for fast.ai to teach me all of these. So I can share it with you!
